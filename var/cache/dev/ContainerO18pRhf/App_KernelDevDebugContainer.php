...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('etHbE05Np+', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('G4WXXHrLqO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ebn8h9g7od', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8W7NoRLNi9', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\CandidatureController', 'App\\Controller\\ChercheurController', 'App\\Controller\\FreelancerController', 'App\\Controller\\HomeController', 'App\\Controller\\IndexController', 'App\\Controller\\ModerateurController', 'App\\Controller\\OffreController', 'App\\Controller\\OffremodController', 'App\\Controller\\RegistrationController', 'App\\Controller\\ResetPasswordController', 'App\\Controller\\SecurityController', 'App\\Controller\\TypecontratController', 'App\\Controller\\TypeoffreController', 'App\\Controller\\UserDataController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getAssetMapperService($container)
    {
        ...
        }, 4), #[\Closure(name: 'asset_mapper', class: 'Symfony\\Component\\AssetMapper\\AssetMapper')] fn () => ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), 'C:\\CareeraPlatform/assets/vendor'), ($container->targetDir.''.'/asset_mapper'), true), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('C:\\CareeraPlatform/public/assets')));
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository(['C:\\CareeraPlatform\\vendor\\symfony\\ux-turbo\\src\\DependencyInjection/../../assets/dist' => '@symfony/ux-turbo', 'C:\\CareeraPlatform\\vendor\\symfony\\stimulus-bundle\\src\\DependencyInjection/../../assets/dist' => '@symfony/stimulus-bundle', 'assets/' => ''], 'C:\\CareeraPlatform', ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LhVmzZAIWb', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GzDmZhgLcq', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('OVb5lFpI-1', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AVI-nJbr8x', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TWajwZlWtO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Css70xHnEu', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('n+qQwjbj2w', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'C:\\CareeraPlatform', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['C:\\CareeraPlatform\\src\\Entity'], true)), 'App\\Entity');
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf', 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src/Resources/translations\\ResetPasswordBundle.ar.xlf'], 'az' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'bs' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf', 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src/Resources/translations\\ResetPasswordBundle.ca.xlf'], 'cs' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf', 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src/Resources/translations\\ResetPasswordBundle.cs.xlf'], 'cy' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.cy.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.cy.xlf'], 'da' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf', 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src/Resources/translations\\ResetPasswordBundle.da.xlf'], 'de' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf', 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src/Resources/translations\\ResetPasswordBundle.de.xlf'], 'el' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf', 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src/Resources/translations\\ResetPasswordBundle.el.xlf'], 'en' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf', 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src/Resources/translations\\ResetPasswordBundle.en.xlf', 'C:\\CareeraPlatform/translations\\messages.en.yaml', 'C:\\CareeraPlatform/translations\\messages.en.yaml'], 'es' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf', 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src/Resources/translations\\ResetPasswordBundle.es.xlf'], 'et' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf', 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src/Resources/translations\\ResetPasswordBundle.fa.xlf'], 'fi' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf', 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src/Resources/translations\\ResetPasswordBundle.fi.xlf'], 'fr' => ['C:\\CareeraPlatform\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 'C:\\CareeraPlatform\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf', 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src/Resources/translations\\ResetPasswordBundle
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'C:\\CareeraPlatform');
        $a->addPath('C:\\CareeraPlatform\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $a->addPath('C:\\CareeraPlatform\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $a->addPath('C:\\CareeraPlatform\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $a->addPath('C:\\CareeraPlatform\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\ux-turbo/templates', 'Turbo');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\ux-turbo/templates', '!Turbo');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\maker-bundle/templates', 'Maker');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\maker-bundle/templates', '!Maker');
        $a->addPath('C:\\CareeraPlatform/templates');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('C:\\CareeraPlatform\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($d, 'C:\\CareeraPlatform', 'UTF-8'));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['C:\\CareeraPlatform\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return [
            'kernel.project_dir' => 'C:\\CareeraPlatform',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'StimulusBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\symfony\\stimulus-bundle',
                    'namespace' => 'Symfony\\UX\\StimulusBundle',
                ],
                'TurboBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\symfony\\ux-turbo',
                    'namespace' => 'Symfony\\UX\\Turbo',
                ],
                'TwigExtraBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\symfony\\maker-bundle',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'SymfonyCastsResetPasswordBundle' => [
                    'path' => 'C:\\CareeraPlatform\\vendor\\symfonycasts\\reset-password-bundle\\src',
                    'namespace' => 'SymfonyCasts\\Bundle\\ResetPassword',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'App_KernelDevDebugContainer',
            'uploads_directory' => 'C:\\CareeraPlatform/public/uploads',
            'images_directory' => 'C:\\CareeraPlatform/public/uploads/images',
            'cv_directory' => 'C:\\CareeraPlatform/public/uploads/cvs',
            'locale' => 'fr',
            ...
            'translator.default_path' => 'C:\\CareeraPlatform/translations',
            ...
            'twig.default_path' => 'C:\\CareeraPlatform/templates',
