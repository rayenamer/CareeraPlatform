...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\CandidatureType' => ['services', 'App\\Form\\CandidatureType', 'getCandidatureTypeService', true],
            'App\\Form\\CandidatureaddType' => ['services', 'App\\Form\\CandidatureaddType', 'getCandidatureaddTypeService', true],
            'App\\Form\\ChangePasswordFormType' => ['services', 'App\\Form\\ChangePasswordFormType', 'getChangePasswordFormTypeService', true],
            'App\\Form\\DiscussionType' => ['services', 'App\\Form\\DiscussionType', 'getDiscussionTypeService', true],
            'App\\Form\\EventType' => ['services', 'App\\Form\\EventType', 'getEventTypeService', true],
            'App\\Form\\EventaddType' => ['services', 'App\\Form\\EventaddType', 'getEventaddTypeService', true],
            'App\\Form\\MessageType' => ['services', 'App\\Form\\MessageType', 'getMessageTypeService', true],
            'App\\Form\\OffreType' => ['services', 'App\\Form\\OffreType', 'getOffreTypeService', true],
            'App\\Form\\ReplyType' => ['services', 'App\\Form\\ReplyType', 'getReplyTypeService', true],
            'App\\Form\\ResetPasswordRequestFormType' => ['services', 'App\\Form\\ResetPasswordRequestFormType', 'getResetPasswordRequestFormTypeService', true],
            'App\\Form\\TypeContratType' => ['services', 'App\\Form\\TypeContratType', 'getTypeContratTypeService', true],
            'App\\Form\\TypeEvenementType' => ['services', 'App\\Form\\TypeEvenementType', 'getTypeEvenementTypeService', true],
            'App\\Form\\TypeEventaddType' => ['services', 'App\\Form\\TypeEventaddType', 'getTypeEventaddTypeService', true],
            'App\\Form\\TypeOffreType' => ['services', 'App\\Form\\TypeOffreType', 'getTypeOffreTypeService', true],
