 ...
 */
class getChercheurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChercheurRepository' shared autowired service.
     *
     * @return \App\Repository\ChercheurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChercheurRepository.php';

        return $container->privates['App\\Repository\\ChercheurRepository'] = new \App\Repository\ChercheurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
