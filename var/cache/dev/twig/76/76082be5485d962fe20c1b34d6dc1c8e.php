...
class __TwigTemplate_b2a9450a4a489a22caaa3ff1aa58c010 extends Template
{
...
";
    ...
    {
        return array (  225 => 54,  218 => 52,  216 => 51,  208 => 48,  200 => 43,  196 => 41,  192 => 39,  184 => 35,  182 => 34,  176 => 31,  172 => 30,  168 => 29,  164 => 28,  160 => 27,  155 => 25,  151 => 24,  148 => 23,  143 => 22,  138 => 19,  131 => 17,  125 => 15,  115 => 13,  113 => 12,  110 => 11,  106 => 10,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
        ...
        <div class=\"row\">
            ...
            <div class=\"col-md-8\">
                {% for profile in tabprofile %}
                    ...
                    <!-- Bouton Modifier -->
                    <a href=\"{{ path('app_updatefreelancer', {'id': profile.id}) }}\" class=\"btn btn-success mt-3\">
                        Modifier
                    </a>

                    <!-- Bouton Supprimer -->
                    <a href=\"{{ path('app_deletefreelancer', {'id': profile.id}) }}\" class=\"btn btn-danger mt-3\" onclick=\"return confirm('Êtes-vous sûr de vouloir supprimer ce profil ?')\">
                        Supprimer
                    </a>
                {% else %}
...
{% endblock %}
", "security/profilefreelancer.html.twig", "C:\\Users\\hedir\\OneDrive\\Desktop\\Careera\\templates\\security\\profilefreelancer.html.twig");
    }
}
