...
class __TwigTemplate_486f13f16d478039c36c66933cb6e07e extends Template
{
    ...
    <div class=\"card shadow-lg p-4\">
        ...
        if ((array_key_exists("tabprofile", $context) &&  !(null === (isset($context["tabprofile"]) || array_key_exists("tabprofile", $context) ? $context["tabprofile"] : (function () { throw new RuntimeError('Variable "tabprofile" does not exist.', 22, $this->source); })())))) {
            ...
            yield "
                    ...
                    <a href=\"";
            // line 42
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_updatechercheur", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["tabprofile"]) || array_key_exists("tabprofile", $context) ? $context["tabprofile"] : (function () { throw new RuntimeError('Variable "tabprofile" does not exist.', 42, $this->source); })()), "id", [], "any", false, false, false, 42)]), "html", null, true);
            yield "\" class=\"btn btn-success mt-3\">
                    ...
                    <a href=\"";
            // line 47
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_deletechercheur", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["tabprofile"]) || array_key_exists("tabprofile", $context) ? $context["tabprofile"] : (function () { throw new RuntimeError('Variable "tabprofile" does not exist.', 47, $this->source); })()), "id", [], "any", false, false, false, 47)]), "html", null, true);
        ...
        <div class=\"row\">
            ...
            <div class=\"col-md-8\">
                {% if tabprofile is defined and tabprofile is not null %}
                    ...
                    <!-- Bouton Modifier -->
                    <a href=\"{{ path('app_updatechercheur', {'id': tabprofile.id}) }}\" class=\"btn btn-success mt-3\">
                        Modifier
                    </a>

                    <!-- Bouton Supprimer -->
                    <a href=\"{{ path('app_deletechercheur', {'id': tabprofile.id}) }}\" class=\"btn btn-danger mt-3\" onclick=\"return confirm('Êtes-vous sûr de vouloir supprimer ce profil ?')\">
                        Supprimer
                    </a>
                {% else %}
...
{% endblock %}", "security/profilechercheur.html.twig", "C:\\careera\\templates\\security\\profilechercheur.html.twig");
    }
}
