...
class __TwigTemplate_adf7e0df952d3777ce223633d8c98869 extends Template
{
    ...
    ";
        // line 8
        if ( !Twig\Extension\CoreExtension::testEmpty((isset($context["notifications"]) || array_key_exists("notifications", $context) ? $context["notifications"] : (function () { throw new RuntimeError('Variable "notifications" does not exist.', 8, $this->source); })()))) {
            // line 9
            yield "        <ul>
            ";
            // line 10
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["notification"]) {
                ...
                yield "                <li>
                    <strong>";
                // line 12
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["notification"], "message", [], "any", false, false, false, 12), "html", null, true);
                yield "</strong>
                </li>
            ";
            }
    ...
    ";
            ...
            // line 17
            yield "        <p>Aucune notification pour le moment.</p>
    ";
        }
    ...
    {
        return array (  129 => 17,  125 => 15,  116 => 12,  113 => 11,  109 => 10,  106 => 9,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    {% endif %}
{% endblock %}
", "notifications/index.html.twig", "C:\\Users\\wiem\\Desktop\\CareeraPlatform\\templates\\notifications\\index.html.twig");
    }
}
