...
class __TwigTemplate_1ea1ef8352bb1735e13a02689356df16 extends Template
{
    ...
    <div class=\"card shadow-lg p-4\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["profile"]) {
            ...
            // line 28
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "email", [], "any", true, true, false, 28)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "email", [], "any", false, false, false, 28), "html", null, true)) : ("Email indisponible"));
            yield "</p>
                    <p><strong>Téléphone :</strong> ";
            // line 29
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "tel", [], "any", true, true, false, 29)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "tel", [], "any", false, false, false, 29), "html", null, true)) : ("Téléphone indisponible"));
            yield "</p>
                    <p><strong>Adresse :</strong> ";
            // line 30
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "Adresse", [], "any", true, true, false, 30)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "Adresse", [], "any", false, false, false, 30), "html", null, true)) : ("Adresse indisponible"));
            yield "</p>
                    <p><strong>Domaine :</strong> ";
            // line 31
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "domaine", [], "any", true, true, false, 31)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "domaine", [], "any", false, false, false, 31), "html", null, true)) : ("Domaine indisponible"));
            yield "</p>
                    <p><strong>Sexe :</strong> ";
            // line 32
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "sexe", [], "any", true, true, false, 32)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "sexe", [], "any", false, false, false, 32), "html", null, true)) : ("Sexe indisponible"));
            yield "</p>
            ...
            yield "
                    ...
                    <a href=\"";
            // line 43
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("updatechercheur", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "id", [], "any", false, false, false, 43)]), "html", null, true);
            yield "\" class=\"btn btn-success mt-3\">
                    ...
                    <a href=\"";
            // line 48
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("profile_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["profile"], "id", [], "any", false, false, false, 48)]), "html", null, true);
...
";
    ...
    {
        return array (  225 => 54,  218 => 52,  216 => 53,  208 => 48,  200 => 43,  196 => 41,  192 => 39,  184 => 35,  182 => 34,  177 => 32,  173 => 31,  169 => 30,  165 => 29,  161 => 28,  155 => 25,  151 => 24,  148 => 23,  143 => 22,  138 => 19,  131 => 17,  125 => 15,  115 => 13,  113 => 12,  110 => 11,  106 => 10,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
        ...
        <div class=\"row\">
            ...
            <div class=\"col-md-8\">
                {% for profile in tabprofile %}
                    ...
                    <!-- Modify button (green) -->
                    <a href=\"{{ path('updatechercheur', {'id': profile.id}) }}\" class=\"btn btn-success mt-3\">
                        Modifier
                    </a>

                    <!-- Delete button (red) -->
                    <a href=\"{{ path('profile_delete', {'id': profile.id}) }}\" class=\"btn btn-danger mt-3\" onclick=\"return confirm('Êtes-vous sûr de vouloir supprimer ce profil ?')\">
                        Supprimer
                    </a>
                {% else %}
