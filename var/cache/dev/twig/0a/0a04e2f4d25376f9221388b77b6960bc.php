...
class __TwigTemplate_a7e311add453665a559f785509b3f8a8 extends Template
{
    ...
    <div class=\"col-md-6\">
        ...
        // line 18
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("register_freelancer");
        yield "'\"
            >
                Freelancer
            </button>
            ...
            <button 
                ...
                onclick=\"window.location.href='";
        // line 27
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("register_chercheur");
        yield "'\"
            >
            ...
            <button 
                ...
                onclick=\"window.location.href='";
        // line 36
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("register_moderateur");
        yield "'\"
            >
                RH / Recruteur
            </button>
    ...
    <div class=\"col-md-6\">
        <div class=\"card shadow p-4 text-center\">
            ...
            <button 
                class=\"btn btn-outline-primary w-100 mb-3\" 
                style=\"font-size: 1rem;\" 
                onclick=\"window.location.href='{{ path('register_freelancer') }}'\"
            >
                Freelancer
            </button>
            ...
            <button 
                class=\"btn btn-outline-primary w-100 mb-3\" 
                style=\"font-size: 1rem;\" 
                onclick=\"window.location.href='{{ path('register_chercheur') }}'\"
            >
                Jeune Diplômé / Professionnel
            </button>
            ...
            <button 
                class=\"btn btn-outline-primary w-100\" 
                style=\"font-size: 1rem;\" 
                onclick=\"window.location.href='{{ path('register_moderateur') }}'\"
            >
                RH / Recruteur
            </button>
        </div>
...
{% endblock %}
", "register/register.html.twig", "C:\\Users\\choub\\Desktop\\CareeraPlatform - Copie\\templates\\register\\register.html.twig");
    }
}
