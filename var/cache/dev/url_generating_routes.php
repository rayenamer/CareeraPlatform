...
return [
    ...
    'get_conversation' => [['messager1Id', 'messager2Id'], ['_controller' => 'App\\Controller\\MessageController::getConversation'], [], [['variable', '/', '[^/]++', 'messager2Id', true], ['variable', '/', '[^/]++', 'messager1Id', true], ['text', '/messages']], [], [], []],
    'send_message' => [['messager1Id', 'messager2Id'], ['_controller' => 'App\\Controller\\MessageController::sendMessage'], [], [['variable', '/', '[^/]++', 'messager2Id', true], ['variable', '/', '[^/]++', 'messager1Id', true], ['text', '/send']], [], [], []],
    ...
    'App\Controller\MessageController::getConversation' => [['messager1Id', 'messager2Id'], ['_controller' => 'App\\Controller\\MessageController::getConversation'], [], [['variable', '/', '[^/]++', 'messager2Id', true], ['variable', '/', '[^/]++', 'messager1Id', true], ['text', '/messages']], [], [], []],
    'App\Controller\MessageController::sendMessage' => [['messager1Id', 'messager2Id'], ['_controller' => 'App\\Controller\\MessageController::sendMessage'], [], [['variable', '/', '[^/]++', 'messager2Id', true], ['variable', '/', '[^/]++', 'messager1Id', true], ['text', '/send']], [], [], []],
