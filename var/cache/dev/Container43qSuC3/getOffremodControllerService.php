...
class getOffremodControllerService extends App_KernelDevDebugContainer
{
    ...
    {
        $container->services['App\\Controller\\OffremodController'] = $instance = new \App\Controller\OffremodController(($container->services['App\\Repository\\OffreRepository'] ?? $container->load('getOffreRepositoryService')), ($container->privates['security.helper'] ?? $container->load('getSecurity_HelperService')));
