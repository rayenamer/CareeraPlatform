 ...
 */
final class Version20250228091402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE discussion (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(30) NOT NULL, content VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, user_id INT NOT NULL, likes INT DEFAULT 0 NOT NULL, dislikes INT DEFAULT 0 NOT NULL, user_name VARCHAR(30) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, messager2 VARCHAR(100) NOT NULL, messager1 VARCHAR(100) NOT NULL, content VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reply (id INT AUTO_INCREMENT NOT NULL, discussion_id INT NOT NULL, content VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, user_id INT NOT NULL, likes INT DEFAULT 0 NOT NULL, dislikes INT DEFAULT 0 NOT NULL, INDEX IDX_FDA8C6E01ADED311 (discussion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
